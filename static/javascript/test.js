...
window.onload = function() {
    document.getElementById("musicBD").play();
}
...
function showCustomAlert() {
  ...
  // Play the music on user interaction
  var musicBday = document.getElementById("musicBD");
  musicBday.muted = false; // Unmute the audio
  musicBday.play().catch(function(error) {
